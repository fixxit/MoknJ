...
## Notice ##
Version 0.0.1 is a quick and dirty prototype and yet to implement proper GOF patterns. Devevelopment branch is latest, you should slowly start to see dev using better patterns and design and less black box design. 
