...
public class EmployeeBal extends RepositoryBal<EmployeeRepository> implements ModuleBal<Employee> {
     ...
     */
    @Override
    public List<Employee> getAll(String templateId, String menuId, String token) {
    ...
    public Employee save(String templateId, String menuId, Employee record, String token) throws BalException {
        if (templateId != null) {
            ...
            String changed = (record.getId() != null
                    && record.equals(repository.findOne(record.getId())))
                    ? "no_changes" : "has_changes";
            /**
             * Find unique fields for employee and check if the current list of
             * employees is unique for the field...
             */
    ...
    @Override
    public void delete(Employee record, String menuId, String token, boolean cascade) {
